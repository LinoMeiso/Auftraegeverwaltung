...
namespace AufträgeOrgadata
{
    ...
    public partial class MainWindow
    {
        ...
        private void mSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            var daten = new StammName();
            var stamm = new Tstamm { StammListUebergabe = new List<Tstamm>() };
            var atCheckedStamm = false;
            for (var i = 0; i < daten.StammListe.Count; i++)
            {
